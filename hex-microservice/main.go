...
// https://wwwo.google.com -> 6trrrr-239
// https://localhost:8000/6trrrr-239 -> https://www.google.com
...
func chooseRepo() shortener.RedirectRepository {
	...
	case "redis":
		redirectURL := os.Getenv("REDIS_URL")
		repo, err := rr.NewRedisRepository(redirectURL)
		if err != nil {
			log.Fatal(err)
		}
		return repo
	case "mongo":
		...
		repo, err := mr.NewMongoRepository(mongodbURL, mongodb, mongoTimeout)
		if err != nil {
			log.Fatal(err)
		}
		return repo
